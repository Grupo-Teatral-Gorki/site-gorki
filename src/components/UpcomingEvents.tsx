                      ...
                      <DrawerContent className="max-w-lg ml-auto h-full fixed right-0 top-0 rounded-none rounded-l-2xl shadow-2xl p-0 overflow-y-auto bg-white [&::after]:hidden [&::before]:hidden">
                        ...
                        <div className="p-6 pt-16 bg-gradient-to-b from-gray-50 to-white text-black">
                            ...
                            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
                              <div className="flex justify-between items-start mb-6">
                                <div className="flex-1">
                                  ...
                                  <h4 className="text-lg font-bold text-gray-800 mb-2">Ingresso Geral</h4>
                                  <p className="text-sm text-gray-600 leading-relaxed line-clamp-3">
                                    {event.description}
                                  </p>
                                </div>
                                <div className="text-right ml-4">
                                  <div className="bg-yellow-500 text-black px-4 py-2 rounded-xl shadow-md">
                                    <p className="text-xs font-medium">A partir de</p>
                                    <p className="text-2xl font-black">{event.price}</p>
                                  </div>
                                </div>
                              </div>
                              
                              <div className="bg-white rounded-xl p-4 border-2 border-dashed border-gray-200 hover:border-yellow-300 transition-colors">
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                      <p className="font-semibold text-gray-800">Quantidade</p>
                                      <p className="text-xs text-gray-500">Selecione quantos ingressos deseja</p>
                                    </div>
                                  </div>
                                  <div className="flex items-center gap-4">
                                    <button
                                      onClick={() => handleQuantityChange(false)}
                                      className="w-12 h-12 rounded-full bg-gradient-to-r from-gray-100 to-gray-200 hover:from-yellow-100 hover:to-yellow-200 border-2 border-gray-300 hover:border-yellow-400 flex items-center justify-center transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                                      disabled={ticketQuantity <= 1}
                                    >
                                      <span className="text-xl font-bold text-gray-700">−</span>
                                    </button>
                                    <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl px-4 py-2 min-w-[60px]">
                                      <span className="text-2xl font-black text-yellow-800 block text-center">{ticketQuantity}</span>
                                    </div>
                                    <button
                                      onClick={() => handleQuantityChange(true)}
                                      className="w-12 h-12 rounded-full bg-gradient-to-r from-yellow-100 to-yellow-200 hover:from-yellow-200 hover:to-yellow-300 border-2 border-yellow-300 hover:border-yellow-400 flex items-center justify-center transition-all duration-200 shadow-sm hover:shadow-md"
                                    >
                          ...
                          <div className="mb-6">
                            ...
                            <div className="bg-gradient-to-br from-white to-blue-50 rounded-2xl p-6 shadow-lg border border-blue-200 space-y-5">
                              <div className="relative">
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition-all duration-200 bg-white hover:border-gray-300 text-gray-800 font-medium placeholder-gray-400"
                              ...
                              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mt-4">
                                <div className="flex items-start gap-3">
                                  ...
                                  <div>
                                    <p className="text-sm font-medium text-blue-800 mb-1">Informações importantes</p>
                                    <p className="text-xs text-blue-600 leading-relaxed">
                                      Seus dados serão utilizados apenas para emissão dos ingressos e comunicações relacionadas ao evento.
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          {/* Order Summary */}
                          <div className="mb-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border-2 border-green-200 shadow-lg">
                            <h3 className="text-xl font-bold mb-4 text-gray-800 flex items-center gap-2">
                              💰 Resumo do Pedido
                            </h3>
                            <div className="space-y-4">
                              <div className="bg-white rounded-xl p-4 shadow-sm">
                                ...
                                <div className="flex justify-between items-center">
                                  <span className="text-sm text-gray-600">{event.price} cada</span>
                                  <span className="font-semibold text-gray-800">R$ {calculateTotal(event.price, ticketQuantity).toFixed(2)}</span>
                                </div>
                              </div>
                              ...
                              <div className="border-t-2 border-dashed border-green-300 pt-4">
                                <div className="flex justify-between items-center bg-green-100 rounded-xl p-4">
                                  <span className="text-lg font-bold text-green-800">Total a Pagar</span>
                                  <span className="text-2xl font-black text-green-600">R$ {calculateTotal(event.price, ticketQuantity).toFixed(2)}</span>
                                </div>
                              </div>
                              ...
                              <div className="bg-green-50 border border-green-200 rounded-xl p-3">
                                <div className="flex items-center gap-2 text-xs text-green-700">
                                  ...
                                  <span className="font-medium">Pagamento 100% seguro • Ingressos digitais instantâneos</span>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="space-y-4">
                            <button
                              ...
                              className="w-full bg-gradient-to-r from-yellow-400 via-yellow-500 to-orange-400 hover:from-yellow-500 hover:via-yellow-600 hover:to-orange-500 text-black font-black py-5 px-6 rounded-2xl transition-all duration-300 text-lg shadow-xl hover:shadow-2xl transform hover:scale-[1.02] active:scale-[0.98] border-2 border-yellow-300 hover:border-yellow-400"
                            >
