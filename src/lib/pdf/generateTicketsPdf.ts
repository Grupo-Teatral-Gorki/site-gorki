        ...
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .tickets-page { width: 210mm; height: 297mm; padding: 8mm; display:flex; flex-direction: column; justify-content: center; align-items: center; margin: 0; background: white; box-sizing: border-box; }
            .page-grid { display: grid; grid-template-columns: 1fr 1fr; grid-template-rows: repeat(3, 1fr); column-gap: 6mm; row-gap: 6mm; height: 100%; width: 100%; align-items: stretch; justify-items: stretch; }
            .ticket { display: block; background: #0b0b0b; border-radius: 12px; overflow: hidden; border: 2px solid #1f2937; color: #f8fafc; position: relative; height: 100%; min-height: auto; width: 100%; }
            ...
            .brand-badge { display: inline-block; font-weight: 900; letter-spacing: 1px; padding: 2px 6px; border-radius: 6px; background: #f59e0b; color: #111827; font-size: 8px; }
            .brand-logo { height: 40px; width: auto; display: block; filter: brightness(1); }
            .headline { margin-top: 6px; font-size: 10px; letter-spacing: 2px; font-weight: 800; color: #FEC800; text-align: center; }
            .title { margin-top: 3px; font-size: 18px; line-height: 1.2; font-weight: 800; color: #fff; text-align: center; }
            ...
            .chips { display: flex; gap: 10px; flex-wrap: wrap; justify-content: center; margin-bottom: 6px; }
            .chip { font-size: 7px; padding: 2px 6px; border-radius: 9999px; background: #111827; border: 1px solid #f59e0b; color: #f59e0b; font-weight: 700; }
            ...
            @media print { * { -webkit-print-color-adjust: exact !important; color-adjust: exact !important; } body { margin: 0; padding: 0; } .tickets-page { margin: 0; width: 100%; height: 100vh; box-sizing: border-box; } .page-grid { height: 100%; } }
