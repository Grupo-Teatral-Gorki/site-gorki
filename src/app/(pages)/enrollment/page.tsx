...
//   if (course === "adulto" || course === "musical") return adultMusicalSchema;
//   return adultMusicalSchema; // fallback
// };
...
const EnrollmentPage = () => {
  return (
    <div className="flex items-center justify-center bg-gray-50 px-4 h-full min-h-screen">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md text-center">
        <h1 className="text-3xl md:text-5xl font-black mb-8 md:mb-16 text-black tracking-tight">
          Inscrições
        </h1>
        <p className="text-gray-600 text-lg">
          As inscrições para cursos estão temporariamente indisponíveis.
        </p>
